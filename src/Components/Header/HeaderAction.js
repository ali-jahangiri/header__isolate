...
const HeaderAction = ({ action , text , position , handler , hideInMobile , icon }) => (
    <HeaderActionWrapper  className={`header__action ${hideInMobile ? 'header__action--hideInMobile' : ""} header__action--${position}`} hideInMobile={hideInMobile} position={position}>
